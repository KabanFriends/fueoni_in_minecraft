...
scoreboard objectives add foIngameSidebar dummy [{"text":"増え鬼","color":"yellow","bold":"true"},{"text":"[ゲーム中]","color":"gold","bold":"false"}]
scoreboard objectives add foListSidebar dummy [{"text":"増え鬼","color":"yellow","bold":"true"},{"text":"[参加者]","color":"gold","bold":"false"}]
...
scoreboard objectives add foClickStick minecraft.used:minecraft.carrot_on_a_stick