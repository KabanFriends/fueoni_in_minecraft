...
execute if score game_checks foGameData matches 4.. run tellraw @a[tag=foGamePlayer] [{"text":""},{"translate":"fueoni.message.prefix","fallback":"増え鬼","color":"yellow","bold":true},{"text":" » ","color":"gray","bold":false},{"translate":"fueoni.message.starting.players","fallback":"このあとゲームが参加者%1$sで始まります！","color":"green","with":[{"translate":"fueoni.unit.players","fallback":"%1$s人","color":"gold","bold":true,"with":[{"score":{"name":"all_players","objective":"foGameData"},"color":"gold","bold":true}]}]}]
execute if score game_checks foGameData matches 4.. run tellraw @a[tag=foGamePlayer] [{"text":""},{"translate":"fueoni.message.prefix","fallback":"増え鬼","color":"yellow","bold":true},{"text":" » ","color":"gray","bold":false},{"translate":"fueoni.message.starting.oni_count","fallback":"最初の鬼が%1$s抽選されます。","color":"gold","with":[{"translate":"fueoni.unit.players","fallback":"%1$s人","color":"yellow","bold":true,"with":[{"score":{"name":"oni_count","objective":"foGameOption"}}]}]}]
execute if score game_checks foGameData matches 4.. run tellraw @a[tag=foGamePlayer] [{"text":""},{"translate":"fueoni.message.prefix","fallback":"増え鬼","color":"yellow","bold":true},{"text":" » ","color":"gray","bold":false},{"translate":"fueoni.message.starting.oni_instruction","fallback":"鬼になりたい人は、%1$sに入ってください！","color":"gold","with":[{"translate":"fueoni.message.starting.oni_instruction.red_circle","fallback":"赤い輪の中","color":"red","bold":true}]}]
...
execute unless score game_checks foGameData matches 4.. unless score game_noplayer foGameData matches 1 run tellraw @a[advancements={fueoni:spawn_egg/start_game=true}] [{"text":""},{"translate":"fueoni.message.prefix","fallback":"増え鬼","color":"yellow","bold":true},{"text":" » ","color":"gray","bold":false},{"translate":"fueoni.message.starting.lobby_not_set","fallback":"ロビー地点が設定されていません。","color":"red"}]
execute unless score game_checks foGameData matches 4.. if score game_noplayer foGameData matches 1 run tellraw @a[advancements={fueoni:spawn_egg/start_game=true}] [{"text":""},{"translate":"fueoni.message.prefix","fallback":"増え鬼","color":"yellow","bold":true},{"text":" » ","color":"gray","bold":false},{"translate":"fueoni.message.starting.not_enough_players","fallback":"ゲームを始めるには%1$sのプレイヤーが必要です。","color":"red","with":[{"translate":"fueoni.message.starting.not_enough_players.player_count","fallback":"%1$s人以上","color":"gold","with":[{"score":{"name":"req_players","objective":"foGameData"}}]}]}]
