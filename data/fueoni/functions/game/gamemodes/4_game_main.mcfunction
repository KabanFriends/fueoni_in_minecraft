...
#give item to runner
execute as @e[tag=foItemEntity] at @s if entity @a[tag=foGamePlayer,team=foRunner,distance=..1] if entity @s[tag=foEye] run give @a[tag=foGamePlayer,team=foRunner,distance=..1] ender_eye{display:{Name:'{"translate":"fueoni.item.see_through.name","fallback":"透視の目","color":"aqua","bold":true,"italic":false}',Lore:['[{"translate":"fueoni.item.see_through.lore.1","fallback":"%1$sすると数秒間","color":"gray","italic":false,"with":[{"translate":"fueoni.item.see_through.lore.1.right_click","fallback":"右クリック","color":"gold","bold":false,"italic":false}]}]','{"translate":"fueoni.item.see_through.lore.2","fallback":"鬼の位置がわかる。","color":"gray","italic":false}']},HideFlags:63,Enchantments:[{id:"minecraft:vanishing_curse",lvl:1s}]}
execute as @e[tag=foItemEntity] at @s if entity @a[tag=foGamePlayer,team=foRunner,distance=..1] if entity @s[tag=foSpeed] run give @a[tag=foGamePlayer,team=foRunner,distance=..1] splash_potion{display:{Name:'{"translate":"fueoni.item.speed.name","fallback":"スピードポーション","color":"aqua","bold":true,"italic":false}',Lore:['{"translate":"fueoni.item.speed.lore.1","fallback":"30秒間、早く走れるようになる。","color":"gray","italic":false}']},HideFlags:1,Enchantments:[{id:"minecraft:vanishing_curse",lvl:1s}],CustomPotionEffects:[{Id:1,Amplifier:0b,Duration:600}],CustomPotionColor:56831}
execute as @e[tag=foItemEntity] at @s if entity @a[tag=foGamePlayer,team=foRunner,distance=..1] if entity @s[tag=foInvisible] run give @a[tag=foGamePlayer,team=foRunner,distance=..1] potion{display:{Name:'{"translate":"fueoni.item.invisibility.name","fallback":"透明化ポーション","color":"light_purple","bold":true,"italic":false}',Lore:['{"translate":"fueoni.item.invisibility.lore.1","fallback":"飲むと20秒間、透明になる。","color":"gray","italic":false}']},HideFlags:1,Enchantments:[{id:"minecraft:vanishing_curse",lvl:1s}],CustomPotionEffects:[{Id:14,Amplifier:0b,Duration:400,ShowParticles:0b}],CustomPotionColor:16717792}
...
execute as @e[tag=foItemEntity] at @s if entity @a[tag=foGamePlayer,team=foRunner,distance=..1] if entity @s[tag=foKillOni] run give @a[tag=foGamePlayer,team=foRunner,distance=..1] tipped_arrow{display:{Name:'{"translate":"fueoni.item.arrow.name","fallback":"鬼退治の矢","color":"red","bold":true,"italic":false}',Lore:['{"translate":"fueoni.item.arrow.lore.1","fallback":"この矢で鬼を撃つと","color":"gray","italic":false}','{"translate":"fueoni.item.arrow.lore.2","fallback":"その鬼は進行方向の逆を向く。","color":"gray","italic":false}']},HideFlags:63,Enchantments:[{id:"minecraft:vanishing_curse",lvl:1s}],CustomPotionEffects:[{Id:27,Amplifier:0b,Duration:1000000,ShowParticles:0b}],CustomPotionColor:16711680}
...
execute as @a[tag=foGamePlayer,team=foOni,nbt={ActiveEffects:[{Id:27,Amplifier:0b}]}] run tellraw @s [{"text":""},{"translate":"fueoni.message.prefix","fallback":"増え鬼","color":"yellow","bold":true},{"text":" » ","color":"gray","bold":false},{"translate":"fueoni.message.game.arrow_damaged","fallback":"鬼退治されてしまった！","color":"red","bold":true}]
