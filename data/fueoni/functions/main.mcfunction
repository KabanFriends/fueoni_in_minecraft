...
execute if score game_mode foGameData matches 2 if score game_timeleft foGameData matches ..0 if score game_ticksec foGameData matches 0 run replaceitem entity @a[tag=foGamePlayer,team=foRunner] hotbar.0 minecraft:wooden_shovel{display:{Name:"{\"text\":\"逃走者の鈍器\",\"color\":\"yellow\",\"bold\":true,\"italic\":false}",Lore:["{\"text\":\"鬼が来たらこれで引き離せ！\",\"color\":\"gray\",\"italic\":false}","{\"text\":\"使いづらいけど頑張れ！！\",\"color\":\"gray\",\"italic\":false}"]},Unbreakable:1b,HideFlags:63,Enchantments:[{id:"minecraft:knockback",lvl:2s}]}
...
execute if score game_mode foGameData matches 3 if score game_timer foGameData matches 1 run replaceitem entity @a[tag=foGamePlayer,team=foOni] hotbar.0 minecraft:diamond_axe{display:{Name:"{\"text\":\"鬼の金斧\",\"color\":\"red\",\"bold\":true,\"italic\":false}",Lore:["{\"text\":\"金棒じゃないよ金斧だよ\",\"color\":\"gray\",\"italic\":false}","{\"text\":\"逃走者をこれで捕まえろ！\",\"color\":\"gray\",\"italic\":false}"]},HideFlags:63,Unbreakable:1b,Enchantments:[{id:"minecraft:sharpness",lvl:127s},{id:"minecraft:vanishing_curse",lvl:1s}],AttributeModifiers:[{AttributeName:"generic.attackSpeed",Name:"generic.attackSpeed",Amount:100000,Operation:0,UUIDLeast:10807,UUIDMost:946123}]}
...
#respawn
execute if score game_mode foGameData matches 4 run replaceitem entity @a[tag=foGamePlayer,team=foOni,scores={foAliveTime=2}] hotbar.0 minecraft:diamond_axe{display:{Name:"{\"text\":\"鬼の金斧\",\"color\":\"red\",\"bold\":true,\"italic\":false}",Lore:["{\"text\":\"金棒じゃないよ金斧だよ\",\"color\":\"gray\",\"italic\":false}","{\"text\":\"逃走者をこれで捕まえろ！\",\"color\":\"gray\",\"italic\":false}"]},HideFlags:63,Unbreakable:1b,Enchantments:[{id:"minecraft:sharpness",lvl:127s},{id:"minecraft:vanishing_curse",lvl:1s}],AttributeModifiers:[{AttributeName:"generic.attackSpeed",Name:"generic.attackSpeed",Amount:100000,Operation:0,UUIDLeast:10807,UUIDMost:946123}]}
...
execute if score game_mode foGameData matches 4 as @a[tag=foGamePlayer] run scoreboard players set @a[tag=foGamePlayer,scores={foRNGBase=..-1}] foRNGBase 0
#set item
...
#item spawning
execute if score game_mode foGameData matches 4 if score item_timer foGameData matches 633 as @a[tag=foGamePlayer,team=foRunner,scores={foRNGBase=0}] at @s run summon armor_stand ~ ~ ~ {CustomNameVisible:1b,NoGravity:1b,Invulnerable:1b,Marker:0b,Invisible:1b,Tags:["foNeedItem","foEye","foGameEntity","foItemEntity"],DisabledSlots:4144959}
execute if score game_mode foGameData matches 4 if score item_timer foGameData matches 633 as @a[tag=foGamePlayer,team=foRunner,scores={foRNGBase=1}] at @s run summon armor_stand ~ ~ ~ {CustomNameVisible:1b,NoGravity:1b,Invulnerable:1b,Marker:0b,Invisible:1b,Tags:["foNeedItem","foSpeed","foGameEntity","foItemEntity"],DisabledSlots:4144959}
execute if score game_mode foGameData matches 4 if score item_timer foGameData matches 633 as @a[tag=foGamePlayer,team=foRunner,scores={foRNGBase=2}] at @s run summon armor_stand ~ ~ ~ {CustomNameVisible:1b,NoGravity:1b,Invulnerable:1b,Marker:0b,Invisible:1b,Tags:["foNeedItem","foInvisible","foGameEntity","foItemEntity"],DisabledSlots:4144959}
execute if score game_mode foGameData matches 4 if score item_timer foGameData matches 633 as @a[tag=foGamePlayer,team=foRunner,scores={foRNGBase=3}] at @s run summon armor_stand ~ ~ ~ {CustomNameVisible:1b,NoGravity:1b,Invulnerable:1b,Marker:0b,Invisible:1b,Tags:["foNeedItem","foKillOni","foGameEntity","foItemEntity"],DisabledSlots:4144959}
execute if score game_mode foGameData matches 4 if score item_timer foGameData matches 633 as @a[tag=foGamePlayer,team=foRunner] at @s run spreadplayers ~ ~ 30 30 false @e[tag=foItemEntity,limit=1,sort=nearest]
execute if score game_mode foGameData matches 4 if score item_timer foGameData matches 633.. run scoreboard players set item_timer foGameData 0
...
execute if score game_mode foGameData matches 4 as @e[tag=foItemEntity] at @s if entity @a[tag=foGamePlayer,team=foRunner,distance=..1] if entity @s[tag=foKillOni] run give @a[tag=foGamePlayer,team=foRunner,distance=..1] tipped_arrow{display:{Name:"{\"text\":\"鬼退治の矢\",\"color\":\"red\",\"bold\":true,\"italic\":false}",Lore:["{\"text\":\"この矢で鬼を撃つと\",\"color\":\"gray\",\"italic\":false}","[{\"text\":\"その鬼は\",\"color\":\"gray\",\"italic\":\"false\"},{\"text\":\"逃走者\",\"color\":\"green\",\"italic\":false},{\"text\":\"に戻る。\",\"color\":\"gray\",\"italic\":false}]"]},HideFlags:63,Enchantments:[{id:"minecraft:vanishing_curse",lvl:1s}],CustomPotionEffects:[{Id:27b,Amplifier:0b,Duration:1000000,ShowParticles:0b}],CustomPotionColor:16711680}
...
execute if score game_mode foGameData matches 4 as @a[tag=foGamePlayer] run replaceitem entity @s[tag=foInvisible] armor.chest air
...
#item: eye
execute if score game_mode foGameData matches 4 as @a[tag=foGamePlayer,scores={foUseEye=1..}] at @s run kill @e[type=eye_of_ender,distance=..5,limit=1,sort=nearest]
execute if score game_mode foGameData matches 4 as @a[tag=foGamePlayer,scores={foUseEye=1..}] run execute as @a[tag=foGamePlayer] at @s run playsound entity.evoker.prepare_summon voice @s ~ ~ ~ 50.0 1.0
execute if score game_mode foGameData matches 4 as @a[tag=foGamePlayer,scores={foUseEye=1..}] run tellraw @a[tag=foGamePlayer] [{"text":""},{"text":"増え鬼","color":"yellow","bold":"true"},{"text":" » ","color":"gray"},{"text":"誰かが透視の目を使いました！","color":"aqua","bold":"true"},{"text":" これから"},{"text":"10秒間","color":"gold"},{"text":"、鬼の位置が光って見えます！"}]
execute if score game_mode foGameData matches 4 as @a[tag=foGamePlayer,scores={foUseEye=1..}] run effect give @a[tag=foGamePlayer,team=foOni] glowing 10 0 true
execute if score game_mode foGameData matches 4 as @a[tag=foGamePlayer,scores={foUseEye=1..}] run scoreboard players reset @s foUseEye
#item: kill oni
...
execute if score game_mode foGameData matches 4 as @a[tag=foGamePlayer,team=foOni,nbt={ActiveEffects:[{Id:27b,Amplifier:0b}]}] run replaceitem entity @s armor.chest minecraft:leather_chestplate{display:{Name:"{\"text\":\"逃走者の服\",\"color\":\"green\",\"bold\":true,\"italic\":false}",Lore:["{\"text\":\"普通の服だよ\",\"color\":\"gray\",\"italic\":\"false\"}","{\"text\":\"脱げないけどね\",\"color\":\"gray\",\"italic\":\"false\"}"],color:65280},HideFlags:63,Unbreakable:1b,Enchantments:[{id:"minecraft:binding_curse",lvl:1s},{id:"minecraft:vanishing_curse",lvl:1s}]}
execute if score game_mode foGameData matches 4 as @a[tag=foGamePlayer,team=foOni,nbt={ActiveEffects:[{Id:27b,Amplifier:0b}]}] run replaceitem entity @s hotbar.0 minecraft:wooden_shovel{display:{Name:"{\"text\":\"逃走者の鈍器\",\"color\":\"yellow\",\"bold\":true,\"italic\":false}",Lore:["{\"text\":\"鬼が来たらこれで引き離せ！\",\"color\":\"gray\",\"italic\":false}","{\"text\":\"使いづらいけど頑張れ！！\",\"color\":\"gray\",\"italic\":false}"]},Unbreakable:1b,HideFlags:63,Enchantments:[{id:"minecraft:knockback",lvl:2s}]}
execute if score game_mode foGameData matches 4 as @a[tag=foGamePlayer,team=foOni,nbt={ActiveEffects:[{Id:27b,Amplifier:0b}]}] at @s run playsound entity.zombie_villager.converted voice @s ~ ~ ~ 50 1.0
execute if score game_mode foGameData matches 4 as @a[tag=foGamePlayer,team=foOni,nbt={ActiveEffects:[{Id:27b,Amplifier:0b}]}] run tellraw @s [{"text":""},{"text":"増え鬼","color":"yellow","bold":"true"},{"text":" » ","color":"gray"},{"text":"あなたは","color":"gold"},{"text":"鬼退治","color":"red","bold":"true"},{"text":"されました！","color":"gold"},{"text":" 退治されて、あなたは"},{"text":"逃走者","color":"green","bold":"true"},{"text":"になりました。"}]
...
execute if score game_mode foGameData matches 4 as @a[tag=foGamePlayer,team=foOni,nbt={ActiveEffects:[{Id:27b,Amplifier:0b}]}] run team join foRunner @s
