...
execute if score game_mode foGameData matches 2 if score game_timeleft foGameData matches ..0 if score game_ticksec foGameData matches 0 at @e[tag=foStartLocation] run teleport @a[tag=foGamePlayer,team=foOni] ~ -80 ~ ~ 90.0
...
execute if score game_mode foGameData matches 4 run item replace entity @a[tag=foGamePlayer,team=foOni,scores={foAliveTime=2}] armor.chest with minecraft:leather_chestplate{display: {Name: '{"text":"鬼の服","color":"red","bold":true,"italic":false}', Lore: ['{"text":"トマトジュースで染まった","color":"gray","italic":false}', '{"text":"きれいな赤色！","color":"gray","italic":false}'], color: 16711680}, HideFlags: 63, Unbreakable: 1b, Enchantments: [{id: "minecraft:protection", lvl: 127s}, {id: "minecraft:binding_curse", lvl: 1s}, {id: "minecraft:vanishing_curse", lvl: 1s}]}
...
execute if score game_mode foGameData matches 4 as @e[tag=foNeedItem,scores={foEntityTick=2}] run execute as @s[tag=foEye] run data merge entity @s {ArmorItems:[{},{},{},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:[I;907160796,1821854615,-1727336627,-176309982],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZGFhOGZjOGRlNjQxN2I0OGQ0OGM4MGI0NDNjZjUzMjZlM2Q5ZGE0ZGJlOWIyNWZjZDQ5NTQ5ZDk2MTY4ZmMwIn19fQ=="}]}}}}],CustomName:'{"text":"透視","color":"aqua","bold":true}'}
execute if score game_mode foGameData matches 4 as @e[tag=foNeedItem,scores={foEntityTick=2}] run execute as @s[tag=foSpeed] run data merge entity @s {Tags:["foSpeed","foGameEntity","foItemEntity"],ArmorItems:[{},{},{},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:[I;52839116,-179814034,-1783536278,237371388],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZmI0YzFkYmQ4NTQ0Y2ZhZWQ5NjNkZjRkMTM5YmM4YmFjNGI3NmFjNGJiYjMwYWI4NmY3NmZiYzMxYWI5YTcwIn19fQ=="}]}}}}],CustomName:'{"text":"スピード","color":"green","bold":true}'}
execute if score game_mode foGameData matches 4 as @e[tag=foNeedItem,scores={foEntityTick=2}] run execute as @s[tag=foInvisible] run data merge entity @s {Tags:["foInvisible","foGameEntity","foItemEntity"],ArmorItems:[{},{},{},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:[I;-1713100179,1153715042,-1560745282,-1663096525],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZGYyYzlkYzMxNGJlZmM4ZDEyZjJlODc4NmM5NDM1YmZkMjRkOTExNmZjOTRjNWVjNDVmZDgzYmQyZGM4NGE0ZiJ9fX0="}]}}}}],CustomName:'{"text":"透明化","color":"white","bold":true}'}
execute if score game_mode foGameData matches 4 as @e[tag=foNeedItem,scores={foEntityTick=2}] run execute as @s[tag=foKillOni] run data merge entity @s {Tags:["foKillOni","foGameEntity","foItemEntity"],ArmorItems:[{},{},{},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:[I;1234033715,-2071574897,-1089669240,55407181],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvY2IzOWI1YWFkNWVjZmY5NDY3M2NjYTRmOTFmZTc0ZWQyYTQyODhjZjY3M2E3NzAxMGY3NTcwZjFhNTc1MjAifX19"}]}}}}],CustomName:'{"text":"鬼退治","color":"red","bold":true}'}
...
execute if score game_mode foGameData matches 4 as @a[tag=foGamePlayer,team=foRunner] at @s positioned ~ -80 ~ if score @s foItemSpawnTimer >= @s foSpawnTimerEnd if score @s foItemSpawnType matches 0 run summon armor_stand ~ ~ ~ {CustomNameVisible:1b,NoGravity:1b,Invulnerable:1b,Marker:0b,Invisible:1b,Tags:["foNeedItem","foNeedTeleport","foEye","foGameEntity","foItemEntity"],DisabledSlots:4144959}
execute if score game_mode foGameData matches 4 as @a[tag=foGamePlayer,team=foRunner] at @s positioned ~ -80 ~ if score @s foItemSpawnTimer >= @s foSpawnTimerEnd if score @s foItemSpawnType matches 1 run summon armor_stand ~ ~ ~ {CustomNameVisible:1b,NoGravity:1b,Invulnerable:1b,Marker:0b,Invisible:1b,Tags:["foNeedItem","foNeedTeleport","foSpeed","foGameEntity","foItemEntity"],DisabledSlots:4144959}
execute if score game_mode foGameData matches 4 as @a[tag=foGamePlayer,team=foRunner] at @s positioned ~ -80 ~ if score @s foItemSpawnTimer >= @s foSpawnTimerEnd if score @s foItemSpawnType matches 2 run summon armor_stand ~ ~ ~ {CustomNameVisible:1b,NoGravity:1b,Invulnerable:1b,Marker:0b,Invisible:1b,Tags:["foNeedItem","foNeedTeleport","foInvisible","foGameEntity","foItemEntity"],DisabledSlots:4144959}
execute if score game_mode foGameData matches 4 as @a[tag=foGamePlayer,team=foRunner] at @s positioned ~ -80 ~ if score @s foItemSpawnTimer >= @s foSpawnTimerEnd if score @s foItemSpawnType matches 3 run summon armor_stand ~ ~ ~ {CustomNameVisible:1b,NoGravity:1b,Invulnerable:1b,Marker:0b,Invisible:1b,Tags:["foNeedItem","foNeedTeleport","foKillOni","foGameEntity","foItemEntity"],DisabledSlots:4144959}
#spread spawned item
execute if score game_mode foGameData matches 4 as @a[tag=foGamePlayer,team=foRunner] at @s positioned ~ -80 ~ if score @s foItemSpawnTimer >= @s foSpawnTimerEnd run spreadplayers ~ ~ 30 30 false @e[tag=foItemEntity,limit=1,sort=nearest]
#reset timer
...
execute if score game_mode foGameData matches 4 as @e[tag=foItemEntity] at @s if entity @a[tag=foGamePlayer,team=foRunner,distance=..1] if entity @s[tag=foKillOni] run give @a[tag=foGamePlayer,team=foRunner,distance=..1] tipped_arrow{display:{Name:'{"text":"鬼退治の矢","color":"red","bold":true,"italic":false}',Lore:['{"text":"この矢で鬼を撃つと","color":"gray","italic":false}','[{"text":"その鬼は進行方向の逆を向く。","color":"gray","italic":false}]']},HideFlags:63,Enchantments:[{id:"minecraft:vanishing_curse",lvl:1s}],CustomPotionEffects:[{Id:27b,Amplifier:0b,Duration:1000000,ShowParticles:0b}],CustomPotionColor:16711680}
...
execute if score game_mode foGameData matches 4 as @a[tag=foGamePlayer,team=foRunner] run item replace entity @s[tag=foInvisible] armor.chest with air
execute if score game_mode foGameData matches 4 as @a[tag=foGamePlayer,team=foRunner] unless entity @s[nbt={Inventory:[{Slot:102b,id:"minecraft:leather_chestplate"}]}] run item replace entity @s[tag=!foInvisible] armor.chest with minecraft:leather_chestplate{display: {Name: '{"text":"逃走者の服","color":"green","bold":true,"italic":false}', Lore: ['{"text":"普通の服だよ","color":"gray","italic":false}', '{"text":"脱げないけどね","color":"gray","italic":false}'], color: 65280}, HideFlags: 63, Unbreakable: 1b, Enchantments: [{id: "minecraft:binding_curse", lvl: 1s}, {id: "minecraft:vanishing_curse", lvl: 1s}]}
execute if score game_mode foGameData matches 4 as @a[tag=foGamePlayer,team=foOni] unless entity @s[nbt={Inventory:[{Slot:102b,id:"minecraft:leather_chestplate"}]}] run item replace entity @s[tag=!foInvisible] armor.chest with minecraft:leather_chestplate{display: {Name: '{"text":"鬼の服","color":"red","bold":true,"italic":false}', Lore: ['{"text":"トマトジュースで染まった","color":"gray","italic":false}', '{"text":"きれいな赤色！","color":"gray","italic":false}'], color: 16711680}, HideFlags: 63, Unbreakable: 1b, Enchantments: [{id: "minecraft:protection", lvl: 127s}, {id: "minecraft:binding_curse", lvl: 1s}, {id: "minecraft:vanishing_curse", lvl: 1s}]}
