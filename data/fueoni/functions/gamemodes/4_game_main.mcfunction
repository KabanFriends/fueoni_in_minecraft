...
execute as @a[tag=foGamePlayer,scores={foUseEnderPearl=1..}] run tellraw @a[tag=foGamePlayer] [{"text":""},{"translate":"増え鬼%1$s","color":"yellow","bold":true,"with":[{"text":" » ","color":"gray","bold":false}]},{"translate":"誰かが透視の目を使った！","color":"light_purple","bold":true},{"text":" これから%1$s、鬼の位置が光って見えます！","with":[{"translate":"%1$s秒間","color":"gold","with":[{"text":"10","color":"gold"}]}]}]
...
execute as @a[tag=foGamePlayer,team=foOni,nbt={ActiveEffects:[{Id:27b,Amplifier:0b}]}] run tellraw @s [{"text":""},{"translate":"増え鬼%1$s","color":"yellow","bold":true,"with":[{"text":" » ","color":"gray","bold":false}]},{"translate":"%1$sされてしまった！","color":"gold","with":[{"translate":"鬼退治","color":"red","bold":true}]}]
