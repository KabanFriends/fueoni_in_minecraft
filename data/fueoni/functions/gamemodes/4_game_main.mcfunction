...
scoreboard players operation 残り時間(秒) foIngameSidebar = game_timeleft foGameData
#bossbar update
...
execute if score bar_min foGameData matches 10.. if score bar_sec foGameData matches ..9 run bossbar set fo_ingame name [{"text":"残り時間: ","color":"red"},{"score":{"name":"bar_min","objective":"foGameData"},"color":"gold","bold":true},{"text":":0","color":"gold","bold":true},{"score":{"name":"bar_sec","objective":"foGameData"},"color":"gold","bold":true}]
...
execute if score bar_min foGameData matches 10.. if score bar_sec foGameData matches 10.. run bossbar set fo_ingame name [{"text":"残り時間: ","color":"red"},{"score":{"name":"bar_min","objective":"foGameData"},"color":"gold","bold":true},{"text":":","color":"gold","bold":true},{"score":{"name":"bar_sec","objective":"foGameData"},"color":"gold","bold":true}]
...
execute as @a[tag=foGamePlayer,scores={foAliveTime=2}] run tellraw @s [{"text":""},{"text":"増え鬼","color":"yellow","bold":true},{"text":" » ","color":"gray"},{"text":"つかまってしまった！","color":"red","bold":true},{"text":" あなたは鬼になりました。"}]
...
#create rng numbers
execute as @a[tag=foGamePlayer,team=foRunner] if score @s foItemSpawnTimer matches 1 store result score @s foSpawnTimerEnd run loot spawn ~ -500 ~ loot fueoni:fo_rng_spawntimer
execute as @a[tag=foGamePlayer,team=foRunner] if score @s foItemSpawnTimer matches 1 store result score @s foItemSpawnType run loot spawn ~ -500 ~ loot fueoni:fo_rng_itemtype
...
execute at @e[tag=foItemEntity] run execute as @a[tag=foGamePlayer,team=foOni,distance=..1] run execute as @s[tag=!foItemWarn] run tellraw @s [{"text":""},{"text":"増え鬼","color":"yellow","bold":true},{"text":" » ","color":"gray"},{"text":"鬼はアイテムを取ることができません！","color":"red"}]
...
execute as @a[tag=foGamePlayer,team=foOni,nbt={ActiveEffects:[{Id:1b,Amplifier:0b}]}] run tellraw @s [{"text":""},{"text":"増え鬼","color":"yellow","bold":true},{"text":" » ","color":"gray"},{"text":"鬼は移動速度上昇を使えません！","color":"red"}]
execute as @a[tag=foGamePlayer,team=foOni,nbt={ActiveEffects:[{Id:1b,Amplifier:0b}]}] run tag @s remove foInvisible
...
execute as @a[tag=foGamePlayer,team=foOni,nbt={ActiveEffects:[{Id:14b,Amplifier:0b}]}] run tellraw @s [{"text":""},{"text":"増え鬼","color":"yellow","bold":true},{"text":" » ","color":"gray"},{"text":"鬼は透明化を使えません！","color":"red"}]
...
execute as @a[tag=foGamePlayer,scores={foUseEnderPearl=1..}] run tellraw @a[tag=foGamePlayer] [{"text":""},{"text":"増え鬼","color":"yellow","bold":true},{"text":" » ","color":"gray"},{"text":"誰かが透視の目を使いました！","color":"light_purple","bold":true},{"text":" これから"},{"text":"10秒間","color":"gold"},{"text":"、鬼の位置が光って見えます！"}]
...
execute as @a[tag=foGamePlayer,team=foOni,nbt={ActiveEffects:[{Id:27b,Amplifier:0b}]}] run tellraw @s [{"text":""},{"text":"増え鬼","color":"yellow","bold":true},{"text":" » ","color":"gray"},{"text":"鬼退治","color":"red","bold":true},{"text":"されてしまった！","color":"gold"}]
